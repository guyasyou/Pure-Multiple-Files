...
<script id="file-input-template-ak<?php echo $akID?>" type="text/x-jquery-tmpl">
    <div class="selected-file ui-state-default" data-fid="${fID}">
        ...
        <span title="<?php echo t('Remove')?>" class="delete"><i class="fa fa-times"></i></span>
    </div>
</script>
...
<div class="multiple-files-wrapper">
    ...
    <?php if ($akMaxFilesCount) { ?>
        <span class="help-block"><?php echo t('Maximum')?>: <?php echo $akMaxFilesCount?></span>
    <?php } ?>
</div>
<div>
...
<script type="text/javascript">
    $(function() {
        ...
        var multipleFilesCurrentSelected = <?php echo json_encode(isset($currentFiles) ? $currentFiles : []); ?>;
